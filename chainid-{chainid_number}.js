...
// File contracts/KJFIN.sol


pragma solidity ^0.8.14;

contract KJFIN is KAP20 {
    constructor(
        string memory _name,
        string memory _symbol,
        string memory _projectName,
    ...
    function mint(address _to, uint256 _amount) external onlyCommittee whenNotPaused {
        _mint(_to, _amount);
    }

    function burnFrom(address _from, uint256 _amount) external onlyCommittee whenNotPaused {
        _burn(_from, _amount);
    }
}
